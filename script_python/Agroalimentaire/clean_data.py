...
# ================================================================
healthy_path = os.path.join(current_dir, '../../data/raw/Agroalimentaire/CostHealthyFood.csv')
...
result_save_path = os.path.join(current_dir,'../../data/processed/Agroalimentaire/result_agro.csv')

result_agro.to_csv(result_save_path,index_label="id_agro")
