...
<body>
    ...
    <div id="loadingScreen">
        ...
        <p>Processing your responses, please wait...</p>
    </div>
...
<div class="questionnaire-section active">
    <!-- Question 1 -->
    <div class="question">
        <label for="question1">Quel est votre âge ?</label>
        <div class="options">
            <input type="number" id="q1_option1" name="age" min="0" max="120" required>
        </div>
    </div>

    <!-- Question 2 -->
    <div class="question">
        <label for="question2">Quel est votre sexe ?</label>
        <div class="options">
            <input type="radio" id="q2_option1" name="sexe" value="homme" required>
            <label for="q2_option1">Homme</label><br>
            <input type="radio" id="q2_option2" name="sexe" value="femme">
            <label for="q2_option2">Femme</label><br>
            <input type="radio" id="q2_option3" name="sexe" value="autre">
            <label for="q2_option3">Autre</label><br>
        </div>
    </div>

    <!-- Question 3 -->
    <div class="question">
        <label for="question3">Quelle est votre orientation sexuelle ?</label>
        <div class="options">
            <input type="radio" id="q3_option1" name="orientation_sexuelle" value="heterosexuel" required>
            <label for="q3_option1">Hétérosexuel</label><br>
            <input type="radio" id="q3_option2" name="orientation_sexuelle" value="homosexuel">
            <label for="q3_option2">Homosexuel</label><br>
            <input type="radio" id="q3_option3" name="orientation_sexuelle" value="bisexuel">
            <label for="q3_option3">Bisexuel</label><br>
            <input type="radio" id="q3_option4" name="orientation_sexuelle" value="autre">
            <label for="q3_option4">Autre</label><br>
        </div>
    </div>

    <!-- Question 4 -->
    <div class="question">
        <label for="question4">Avez-vous un handicap ?</label>
        <div class="options">
            <input type="radio" id="q4_option1" name="handicap" value="oui" required>
            <label for="q4_option1">Oui</label><br>
            <input type="radio" id="q4_option2" name="handicap" value="non">
            <label for="q4_option2">Non</label><br>
        </div>
    </div>
    
    <!-- Question 5 -->
    <label for="question5">Si oui, quel type d'handicap avez vous?</label>
        <div class="options">
            <input type="checkbox" id="q5_option1" name="type_handicap" value="auditif">
            <label for="q5_option1">Auditif</label><br>
            <input type="checkbox" id="q5_option2" name="type_handicap" value="visuel">
            <label for="q5_option2">Visuel</label><br>
            <input type="checkbox" id="q5_option3" name="type_handicap" value="locomotore">
            <label for="q5_option3">Locomotore</label><br>
            <input type="checkbox" id="q5_option4" name="type_handicap" value="mental">
            <label for="q5_option4">Mental</label><br>
            <input type="checkbox" id="q5_option5" name="type_handicap" value="autre">
            <label for="q5_option5">Autre</label><br>
            <input type="checkbox" id="q5_option6" name="type_handicap" value="pas d'handicap">
            <label for="q5_option6">Pas d'handicap</label><br>
        </div>

    <!-- Question 6 -->
    <div class="question">
        <label for="question6">Êtes-vous en couple ?</label>
        <div class="options">
            <input type="radio" id="q6_option1" name="couple" value="oui" required>
            <label for="q6_option1">Oui</label><br>
            <input type="radio" id="q6_option2" name="couple" value="non">
            <label for="q6_option2">Non</label><br>
        </div>
    </div>
</div>
...
<div class="questionnaire-section">
    ...
    <!-- Question 8 -->
    <div class="question">
        <label for="question8">Accordez-vous de l'importance à l'utilisation des énergies propres (électricité, gaz contrairement au charbon et d'autres combustibles polluants) pour la cuisine ?</label>
        <div class="options">
    ...
    <!-- Question 9 -->
    <div class="question">
        <label for="question9">Dans quelle mesure êtes-vous d'accord avec l'affirmation suivante : "Le coût d'une alimentation saine est un obstacle pour maintenir une diète équilibrée"</label>
        <div class="options">
...
<div class="questionnaire-section">
    <!-- Question 10 -->
    <div class="question">
        <label for="question10">Quel impact apporte dans votre vie la bienveillance des autres?</label>
        <div class="options">
    ...
    <!-- Question 11 -->
    <div class="question">
        <label for="question11">Quel type d'education concerne directement votre vie personnelle?</label>
        <div class="options">
    ...
    <div class="content-container">
        <h1 class="page-header">Veuillez sellectionner les intervales de temperature idéales pour votre pays de destination pendant:</h1>
    </div>
...
<div class="questionnaire-section">
    <!-- Question 16 -->
    <div class="question">
        <label for="question16">Que représente la religion pour vous en termes d'importance ?</label>
        <div class="options">
    ...
    <!-- Question 17 -->
    <div class="question">
        <label for="question17">Quelle importance a pour vous le taux de criminalité d'un pays?</label>
        <div class="options">
    ...
    <!-- Question 18 -->
    <div class="question">
        <label for="question18">À quel point est-il important pour vous que votre pays d'accueil soit ouvert aux visiteurs et échanges internationaux ?</label>
        <div class="options">
...
<div class="questionnaire-section">
    <!-- Question 20 -->
    <div class="question">
        <label for="question20">Quel type de chomage vous concerne sur un pays?</label>
        <div class="options">
    ...
    <!-- Question 21 -->
    <div class="question">
        <label for="question21">Quelles sont vos prioritées en matière de conditions sociales dans un pays ?</label>
        <div class="options">
    ...
    <!-- Question 22 -->
    <div class="question"> 
    <label for="question22">À quel point la générosité des autres est importante pour vous ?</label>
    <div class="options">
        ...
        <label for="q22_option2">Pas trpo important</label><br>
...
<div class="questionnaire-section">
    ...
    <!-- Question 23 -->
    <div class="question"> 
    <label for="question23">Séléctionnez les concepts que vous considerez nécéssaires pour votre pays de destination :</label>
    <div class="options">
    ...
    <!-- Question 24 -->
    <div class="question">
        <label for="question24">Quelles sont vos attentes concernant les conditions de santé d'un pays ?</label>
        <div class="options">
    ...
    <div class="questionnaire-section">
    <div class="question"> 
    <label for="question25">Marquez toutes les concepts économiques importants pour vous :</label>
    <div class="options">
...
<!-- Question 19 -->
<div class="question">
        <label for="question19">À quel point est-il important pour vous de se déplacer à l'aide des transports en commun ?</label>
        <div class="options">
